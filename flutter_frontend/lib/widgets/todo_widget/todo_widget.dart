...
class _TodoWidgetState extends State<TodoWidget> {
  ...
  Future<void> _toggleTodoItem(TodoItem item) async {
    try {
      ...
      setState(() {
        _error = _categorizeError('toggle todo', e);
      });
      
      await _checkForOfflineMode(e);
    }
  }
  ...
  Future<void> _addTodo() async {
    ...
    try {
      ...
      setState(() {
        _error = _categorizeError('add todo', e);
      });
  ...
  Future<void> _deleteTodo(String id) async {
    try {
      ...
      setState(() {
        _error = _categorizeError('delete todo', e);
      });
  ...
  String _categorizeError(String operation, dynamic error) {
    ...
    if (errorString.contains('javascriptobject') || 
      ...
      return 'Data processing error while trying to $operation. This might be due to a browser compatibility issue.';
    }
    
    if (errorString.contains('socket') || 
        errorString.contains('network') ||
        errorString.contains('connection')) {
      return 'Connection error while trying to $operation. Please check your internet connection.';
    }
    
    if (errorString.contains('permission') || 
        errorString.contains('unauthorized') ||
        errorString.contains('forbidden')) {
      return 'Permission error while trying to $operation. Please check your account settings.';
    }
    ...
    if (errorString.contains('javascriptobject') || 
      ...
      if (_retryCount >= 3 && !_isOfflineMode) {
        try {
          ...
          setState(() {
            _isOfflineMode = true;
            _error = 'Switched to offline mode due to data processing issues. You can still view and modify todos locally.';
          });
        } catch (e) {
          // Ignore offline switch errors
        }
      }
    }
  }
  ...
  Future<void> _retryOnline() async {
    try {
      ...
      setState(() {
        _error = 'Failed to switch to online mode: ${e.toString()}';
      });
    }
  }
          ...
          children: [
            ...
            Expanded(
              ...
              if (snapshot.hasError) {
                ...
                final errorMessage = _categorizeError('load todos', error);
                            ...
                            ElevatedButton.icon(
                              onPressed: () async {
                                try {
                                  ...
                                  setState(() {
                                    _isOfflineMode = true;
                                    _error = 'Switched to offline mode. You can view cached todos.';
                                  });
                                } catch (e) {
                                  setState(() {
                                    _error = 'Failed to switch to offline mode: ${e.toString()}';
                                  });
                                }
                              },
